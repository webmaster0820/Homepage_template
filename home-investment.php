						...
						<div class="row">
							<div class="col-12 col-md-12 col-lg-4">
								<div class="navbar-header">
									<a class="logo" href="index.php"> <img src="assets/images/logo/logo-colored.png" alt="logo"> </a>
								</div>
							</div>
							<!-- .col-md-6 end -->
			...
			<ul>
				...
				<li data-transition="zoomout" 
					...
					<div class="tp-caption" 
                        ...
                        data-y="['middle','middle','middle','middle']" data-voffset="['-45','-45','-20','0']"
						data-fontsize="['60', '50', '40', '30']" 
                        data-lineheight="['60','60','60','60']"
						data-width="none"
						data-height="none"
						data-transform_idle="o:1;"
                        data-frames='[{"delay":1000,"speed":1000,"frame":"0","from":"z:0;rX:0deg;rY:0;rZ:0;sX:2;sY:2;skX:0;skY:0;opacity:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]' 						data-splitin="none" 
 						data-responsive_offset="on">
 						<div class="slide--headline text-center">We Are The Leaders Of <br>Financial Investment Market! </div>
  					</div>		
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--bio text-center">The Market Can Price Things Wrong, We Don’t!</div>
 					</div>
					
					<!-- LAYER NR. 3 -->
					<div class="tp-caption" 
				        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                        data-y="['middle','middle','middle','middle']" data-voffset="['135','135','150','170']"
						data-width="none"
						data-height="none"
						...
						<div class="slide-action">
							<a class="btn btn--gradient btn--rounded" href="#">Invest Now!</a>
 						</div>
					</div>
				</li>
				...
				<li data-transition="fadethroughdark"
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--headline text-center">Experienced In Mortgage <br> And Financial Advice!</div>
 					</div>		
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--bio text-center">Just Enjoy Your Best Rates While We Are Doing The Rest For You </div>
 					</div>
				...
				<li data-transition="slidingoverlaydown"
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
 						<div class="slide--headline text-center">Find & Compare The Best <br>Cryptocurrency Exchange Rates</div>
  					</div>		
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 offset-lg-1">
                <div class="heading">
                    ...
                    <h2 class="heading--title color-white mb-0">Internal Accounting, Sales Data & Market Economic Indicators</h2>
                </div>
            </div>
            <!-- .col-lg-10 end -->
        </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="info-card">
                    ...
                    <div class="info-card-content">
                        ...
                        <p class="info-card-desc">Support in person, over the phone and online. Web chat is available from 8am to 8pm or you can give us a call for free money advice.</p>
                        <a class="info-card-links" href="#"><i class="fa fa-plus"></i>Read More</a>
                    </div>
                </div>
                <!-- .info-card end -->
...
<!-- Team #1
============================================= -->
<section id="team1" class="team team-1 pt-110 pb-50">
    <div class="container">
