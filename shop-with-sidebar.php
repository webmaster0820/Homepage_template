        ...
        <div class="row">
                ...
                <div class="product-item">
                    <div class="product--img">
                        ...
                        <div class="product--action">
                            <a href="#" class="btn btn--rounded btn--primary">Add To Cart</a>
                        </div>
                    </div><!-- .product-img end -->
                    <div class="product--content">
                        <div class="product--title">
                            <h3><a href="#">Getting to Know SEO</a></h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="product-item">
                    ...
                    <div class="product--content">        
                        <div class="product--title">
                            <h3><a href="#">Build Blog Business</a></h3>
                        </div><!-- .product-title end -->
                        <div class="product--price">
                            <span>$510.00</span>
                        </div><!-- .product-price end -->
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="product-item">
                    ...
                    <div class="product--content">     
                        <div class="product--title">
                            <h3><a href="#">How to Build Habit</a></h3>
                        </div><!-- .product-title end -->
                        <div class="product--price">
                            <span>$18.00</span>
                        </div><!-- .product-price end -->
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="product-item">
                    ...
                    <div class="product--content">   
                        <div class="product--title">
                            <h3><a href="#">Marketing Theory</a></h3>
                        </div><!-- .product-title end -->
                        <div class="product--price">
                            <span>$17,00</span>
                        </div><!-- .product-price end -->
                    ...
                    <div class="widget--content">
                        ...
                        <div class="product clearfix">
                            ...
                            <div class="product-desc">
                                <div class="product-title">
                                    <a href="#">How to Build Habit Forming Products</a>
                                </div>
                                <div class="product-meta">
                                    <span>$18</span>
                                </div>
                        ...
                        <div class="product clearfix">
                            ...
                            <div class="product-desc">
                                <div class="product-title">
                                    <a href="#">The Great Personal Branding Book</a>
                                </div>
                                <div class="product-meta">
                                    <span>$17</span>
                                </div>
