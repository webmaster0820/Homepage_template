                ...
                <div class="case-item-container">
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4><a href="case-study-single.php">Grow your business with an unexpected niche!</a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 case-item filter-Investment">
                <div class="case-item-container">
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4><a href="case-study-single.php">Use credit reporting to improve client relationships.</a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 case-item filter-tips filter-Consulting">
                <div class="case-item-container">
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4><a href="case-study-single.php">State stamp duty surcharges for foreign buyers.</a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 case-item filter-environment filter-Consulting">
                <div class="case-item-container">
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4><a href="case-study-single.php">Government changes on transfer of land or duty. </a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 case-item filter-tips">
                <div class="case-item-container">
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4><a href="case-study-single.php">How to explain the ASIC inquiry to clients!</a></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 case-item filter-consulting">
                <div class="case-item-container">
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4><a href="case-study-single.php">How blockchain technology will impact the broking?</a></h4>
                        </div>
                    </div>
                </div>
            </div>
