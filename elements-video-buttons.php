			...
			<div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
				<div class="title text-center">
					...
					<ol class="breadcrumb d-flex justify-content-center">
						...
						<li class="breadcrumb-item active" aria-current="page">video buttons</li>
					</ol>
				</div><!-- .title end -->
			</div><!-- .col-lg-8 end -->
		</div><!-- .row end -->
...
<!-- Video #1
============================================= -->
<section id="video1" class="video-1">
    <div class="container">
        <div class="row">
...
<!-- video  #3
============================================= -->
<section id="video3" class="video video-3 text-center">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 video-container bg-overlay bg-overlay-dark4">
                <div class="bg-section"><img src="assets/images/video/1.jpg" alt="background"></div>
                <div class="heading mb-60">
                    <p class="heading--subtitle">Profitable And Successful Investments</p>
                    <h2 class="heading--title color-white mb-0">Internal Accounting, Sales Data & <br>Market   Economic Indicators</h2>
                </div>
