...
<li class="has-dropdown active">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="home-consulting.php">Home Consulting</a>
        </li>
        <li>
            <a href="home-advisor.php">Home advisor</a>
        </li>
        <li>
            <a href="home-investment.php">Home investment</a>
        </li>
        <li>
            <a href="home-advisory.php">Home advisory</a>
        </li>
    </ul>
</li>
<!-- li end -->
...
<li class="has-dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li>
            <a href="page-our-team.php">our team</a>
        </li>
        <li>
            <a href="page-gallery.php">our gallery</a>
        </li>
        <li>
            <a href="page-contact.php">contacts</a>
        </li>
        <li>
            <a href="page-faqs.php">FAQs</a>
        </li>
        <li>
            <a href="page-consultation.php">consultation</a>
        </li>
    </ul>
</li>
<!-- li end -->
...
<li class="has-dropdown">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="page-services.php">services grid</a>
        </li>
        <li>
            <a href="page-services-single.php">services single</a>
        </li>
        <li>
...
<li class="has-dropdown">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="case-studies-grid.php">case grid</a>
        </li>
        <li>
            <a href="case-studies-standard.php">case standard</a>
        </li>
        <li>
            <a href="case-study-single.php">case single</a>
        </li>
    </ul>
</li>
<!-- li end -->
...
<li class="has-dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li>
            <a href="blog-standard.php">blog standard</a>
        </li>
        <li>
...
<li class="has-dropdown">
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="shop-4columns.php">shop 4columns</a>
        </li>
        <li>
            <a href="shop-with-sidebar.php">shop sidebar</a>
        </li>
        <li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3">
							<ul>
								<li>
									<a href="elements-testimonials.php"><i class="fa fa-quote-right"></i>testimonials</a>
								</li>
								<li>
									<a href="elements-video-buttons.php"><i class="fa fa-toggle-right"></i>video buttons</a>
								</li>
								<li>
									<a href="elements-clients.php"><i class="fa fa-user"></i>clients</a>
								</li>
							</ul>
						</div>
						<!-- .col-md-3 end -->
						...
						<div class="col-md-3">
							<ul>
								<li>
									<a href="elements-accordion.php"><i class="fa fa-server"></i>accordion</a>
								</li>
								<li>
									<a href="elements-cta.php"><i class="fa fa-child"></i>call to action</a>
								</li>
								<li>
									<a href="elements-contact-form.php"><i class="fa fa-desktop"></i>contact form</a>
								</li>
							</ul>
						</div>
						<!-- .col-md-3 end -->
						...
						<div class="col-md-3">
							<ul>
				                <li>
									<a href="elements-team.php"><i class="fa fa-group"></i>team variations</a>
								</li>
 
								<li>
									<a href="elements-counters.php"><i class="fa fa-dashboard"></i>counters</a>
								</li>
								<li>
									<a href="elements-infocards.php"><i class="fa fa-info-circle"></i>info Cards</a>
								</li>
						...
						<div class="col-md-3">
							<ul>
								<li>
									<a href="elements-featured.php"><i class="fa fa-sliders"></i>featured box</a>
								</li>
				                <li>
									<a href="elements-pricing.php"><i class="fa fa-exchange"></i>pricing</a>
								</li>
							</ul>
						</div>
						<!-- .col-md-3 end -->
...
<div class="module module-consultation pull-left">
	<a class="btn" href="page-contact.php">Consultation</a>
</div>				<!-- Module Search -->
...
<section id="gallery" class="gallery gallery-standard gallery-3col bg-white">
	<div class="container">
		<div class="row">
			...
			<div class="col-12 col-md-12 col-md-12 gallery-filter">
				<ul class="list-inline mb-0">
					...
					<li><a href="#" data-filter=".filter-office">Our Office</a></li>
					<li><a href="#" data-filter=".filter-room">Play Room</a></li>
					<li><a href="#" data-filter=".filter-workspaces">Workspaces</a></li>
				</ul>
			</div>
			<!-- .gallery-filter end --> 
		</div>
		<div id="gallery-all" class="row">
			<!-- gallery #1 -->
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-office">
				<div class="gallery--img">
					<img src="assets/images/gallery/1.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/1.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<!-- gallery #2 -->
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-room">
				<div class="gallery--img">
					<img src="assets/images/gallery/2.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/2.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-room">
				<div class="gallery--img">
					<img src="assets/images/gallery/3.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/3.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-room">
				<div class="gallery--img">
					<img src="assets/images/gallery/4.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/4.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-office">
				<div class="gallery--img">
					<img src="assets/images/gallery/5.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/5.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<!-- gallery #6 -->
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-workspaces">
				<div class="gallery--img">
					<img src="assets/images/gallery/6.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/6.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<!-- gallery #7 -->
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-packaging">
				<div class="gallery--img">
					<img src="assets/images/gallery/7.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/7.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-room">
				<div class="gallery--img">
					<img src="assets/images/gallery/8.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/8.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
			...
			<div class="col-12 col-md-6 col-lg-4 gallery-item filter-workspaces">
				<div class="gallery--img">
					<img src="assets/images/gallery/9.jpg" alt="gallery Item">
					<div class="gallery--hover">
						<div class="gallery--action">
							<div class="pos-vertical-center">
								<div class="gallery-zoom">
									<a class="img-popup" href="assets/images/gallery/full/9.jpg" title="gallery Item">
										<i class="icon--zoom"></i>
									</a>
								</div>
							</div>
